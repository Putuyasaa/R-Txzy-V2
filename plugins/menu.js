    ...
    if (teks == '404') {
			return conn.relayWAMessage(conn.prepareMessageFromContent(m.chat, {
                    "listMessage":  {
                        ...
                        "description": `© *Kupyet-Bots*`.trim(),
                        "footerText": "Jika menemukan bug, error atau kesulitan dalam penggunaan silahkan laporkan/tanyakan kepada kupyet.",
                        ...
                        "sections": [
                            {
                                ...
                                "rows": [{
                                    "title": "Owner bot",
                                    "description": "pemilik R-Txzy recode JuniArta",
                                    "rowId": ".owner"
                                }, {
                                    "title": "Donasi",
