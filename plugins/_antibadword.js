...
ketik *#tobat goblok* atau *#maaf* untuk mengurangi warning

“Nakal boleh goblok jangan? Ngomong kasar gapapa yang penting batas wajar? Orang pintar ga bakal bangga jani nakal, orang sukses kalau lagi meeting ga mungkin ngomong kasar.).`, watermark, 'Nyalakan Antibadword', ',1 antibadword', 'tobat', ',maaf', m)
        if (user.warning >= 5) {
            user.banned = true
            if (m.isGroup) {
                if (isBotAdmin) {
